...
const singleQuoteString = 'Hello, World this is a string with single quotes.';
const doubleQuoteString = "Hello, World this is a string with double quotes.";
// Template literals (backticks) allow for multi-line strings and embedding expressions
const programerName = 'Alice';
const programerAge = 30;
const templateLiteralString = `Hello, ${programerName}!
